__author__ = 'PARAS KUMAR'
__version__ = 'v1'
__builddate__ = '2023/01/8'

import movement as movement

# Python 3.11 , Pygame 1.9.6
# HELP v1 ENGINE, WRITTEN BY PARAS KUMAR
...
pygame.display.set_caption('SuperMarioBrothers - PyGame - PARAS KUMAR')  # Set the window title.
...
small_flag_img = pygame.image.load('flag/flag_0.png').convert()
small_flag_img.set_colorkey((255, 255, 255))

playerDead_img = pygame.image.load('die_0.png').convert()
playerDead_img.set_colorkey((255, 255, 255))

mushroom_img = pygame.image.load('pop_0.png').convert()
mushroom_img.set_colorkey((255, 255, 255))

flower_img = pygame.image.load('fpop_0.png').convert()
flower_img.set_colorkey((255, 255, 255))

bomber_img = pygame.image.load('bomber_pop_0.png').convert()
bomber_img.set_colorkey((255, 255, 255))

bomb_img = pygame.image.load('bomb_0.png').convert()
bomb_img.set_colorkey((255, 255, 255))

explosion_img = pygame.image.load('explosion/explosion_0.png').convert()
explosion_img.set_colorkey((255, 255, 255))

fireball_img = pygame.image.load('fireball/fireball_0.png').convert()
fireball_img.set_colorkey((255, 255, 255))

coin_img = pygame.image.load('coin/coin_0.png').convert()
coin_img.set_colorkey((255, 255, 255))

coin_bounce_img = pygame.image.load('coin/coin_bounce_0.png').convert()
coin_bounce_img.set_colorkey((255, 255, 255))

flag_img = pygame.image.load('flag/flag.png').convert()
flag_img.set_colorkey((255, 255, 255))

brick_img = pygame.image.load('wall/brick_0.png')
broken_brick_img = pygame.image.load('wall/broken.png')
block_img = pygame.image.load('wall/block.png')

pipe0_img = pygame.image.load('pipes/pipe_0.png').convert()
pipe0_img.set_colorkey((255, 255, 255))
pipe1_img = pygame.image.load('pipes/pipe_1.png').convert()
pipe1_img.set_colorkey((255, 255, 255))
pipe2_img = pygame.image.load('pipes/pipe_2.png').convert()
pipe2_img.set_colorkey((255, 255, 255))

cloud0_img = pygame.image.load('background/cloud_0.png').convert()
cloud0_img.set_colorkey((255, 255, 255))
grass0_img = pygame.image.load('background/grass_0.png').convert()
grass0_img.set_colorkey((255, 255, 255))
hill0_img = pygame.image.load('background/hill_0.png').convert()
hill0_img.set_colorkey((255, 255, 255))
hill1_img = pygame.image.load('background/hill_1.png').convert()
hill1_img.set_colorkey((255, 255, 255))
castle0_img = pygame.image.load('background/castle_0.png').convert()
castle0_img.set_colorkey((255, 255, 255))

what_block_img = pygame.image.load('what/what_0.png').convert()
what_block_img.set_colorkey((255, 255, 255))

empty_what_block_img = pygame.image.load('what/empty.png')

goomba_img = pygame.image.load('goomba_run/goomba_run_0.png').convert()
goomba_img.set_colorkey((255, 255, 255))
koopa_img = pygame.image.load('koopa_run/koopa_run_0.png').convert()
...
animation_database['bomberidle'] = load_animation('bomber/bomberidle', [7])
animation_database['bomberrun'] = load_animation('bomber/bomberrun', [7, 7, 7])
animation_database['bomberjump'] = load_animation('bomber/bomberjump', [7])
animation_database['bomberdie'] = load_animation('bomber/bomberdie', [7])

animation_database['firetobomber'] = load_animation('bomber/firetobomber', [22, 22])
animation_database['bombertofire'] = load_animation('bomber/bombertofire', [22, 22])

animation_database['fireidle'] = load_animation('fire/fireidle', [7])
animation_database['firerun'] = load_animation('fire/firerun', [7, 7, 7])
animation_database['firejump'] = load_animation('fire/firejump', [7])
animation_database['firedie'] = load_animation('fire/firedie', [7])

animation_database['bigtofire'] = load_animation('fire/bigtofire', [22, 22])
animation_database['firetobig'] = load_animation('fire/firetobig', [22, 22])

animation_database['bigrun'] = load_animation('big/bigrun', [7, 7, 7])
animation_database['bigjump'] = load_animation('big/bigjump', [7])
animation_database['bigdie'] = load_animation('big/bigdie', [7])
animation_database['bigidle'] = load_animation('big/bigidle', [7])
animation_database['big_to_small'] = load_animation('big/big_to_small', [22, 22])
animation_database['small_to_big'] = load_animation('small/small_to_big', [22, 22])
animation_database['smallrun'] = load_animation('small/run', [7, 7, 7])
animation_database['smalljump'] = load_animation('small/jump', [7])
animation_database['smalldie'] = load_animation('small/die', [7])
animation_database['smallidle'] = load_animation('small/idle', [7])
animation_database['smallflag'] = load_animation('small/flag', [7])

# Load enemy's animations
animation_database['goomba_run'] = load_animation('goomba_run', [7, 7])
animation_database['goomba_die'] = load_animation('goomba_die', [7])
animation_database['koopa_run'] = load_animation('koopa_run', [7, 7])
animation_database['koopa_die'] = load_animation('koopa_die', [7])

# Load object animations
animation_database['what'] = load_animation('blocks/what', [14, 14, 14, 14])
animation_database['brick'] = load_animation('blocks/brick/brick', [4, 4, 4, 4, 4, 4, 4])
animation_database['brick_idle'] = load_animation('blocks/brick/brick_idle', [7])
animation_database['fireball'] = load_animation('fireball', [7, 7, 7, 7])
# Load consumables animations
animation_database['coin'] = load_animation('objects/coin', [7, 7, 7, 7, 7])
animation_database['coin_bounce'] = load_animation('objects/coin_bounce', [2, 2, 2, 2, 2, 2, 2, 2])
animation_database['pop'] = load_animation('objects/mushroom/pop', [7, 7, 7, 7])
animation_database['mushroom'] = load_animation('objects/mushroom', [7])
animation_database['flower'] = load_animation('objects/flower/flower', [7, 7, 7, 7])
animation_database['fpop'] = load_animation('objects/flower/fpop', [7, 7, 7, 7, 7])
animation_database['bomber_pop'] = load_animation('objects/bomber/bomber_pop', [7, 7, 7, 7])
animation_database['bomber'] = load_animation('objects/bomber/bomber', [7, 7, 7, 7])
animation_database['bomb'] = load_animation('objects/bomb', [7, 7, 7, 7])
animation_database['explosion'] = load_animation('objects/explosion', [2, 2, 3, 3, 4, 4, 4, 4])
...
class Koopa():
    ...
    def render(self, surf):
        self.loc[0] = self.rect.x
        self.loc[1] = self.rect.y
        surf.blit(pygame.transform.flip(self.img, self.xflip, self.flip),
...
while not IsGameOver or True:  # Main game loop
    ...
    if not player_flash:
        display.blit(pygame.transform.flip(player_img, player_flip, False),
                     (player_rect.x - scrollx, player_rect.y - scrolly))  # player render
